...
#define PUBLISHER_SHARE_OF_WEAK_MOVIE 0.80
#define PUBLISHER_SHARE_OF_MEDIUM_MOVIE 0.90
#define PUBLISHER_SHARE_OF_STRONG_MOVIE 0.95
...
int Publisher::clculate_income(int price_of_movie, double rate)
{
	...
	if(rate < 5)
		publisher_income = PUBLISHER_SHARE_OF_WEAK_MOVIE * price_of_movie;
	if(rate >= 8)
		publisher_income = PUBLISHER_SHARE_OF_STRONG_MOVIE * price_of_movie;
	else
		publisher_income = PUBLISHER_SHARE_OF_MEDIUM_MOVIE * price_of_movie;
